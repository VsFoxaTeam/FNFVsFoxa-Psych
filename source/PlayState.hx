...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Wow, you suck ass....', 0.2], //From 0% to 19%
		['Oh shucks!', 0.4], //From 20% to 39%
		...
		['The fox is mad', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		var songTxt = new FlxText(12, FlxG.height - 24, 0, "", 8);
		...
		add(songTxt);
		songTxt.text = curSong + " (" + storyDifficultyText + ") " + "| Vs. Foxa (Modified Psych " + MainMenuState.psychEngineVersion + ")";

		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "BOTPLAY", 32);
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		botplayTxt.scrollFactor.set();
		botplayTxt.borderSize = 2; // = 1.25;
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			...
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Health: ' + health + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;//peeps wanted no integer rating
		}
	...
	override function beatHit()
	{
		...
		// source port of that one icon bop script
		if (curBeat % 2 == 0) 
		{
